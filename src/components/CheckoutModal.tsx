...
interface CheckoutModalProps {
  ...
  onSwitchWallet?: () => void; // Called when user wants to switch wallets
}
...
export function CheckoutModal({
  ...
  const { resetCheckout, step } = useCheckout();
        ...
        >
          ...
          <ThemeProvider theme={theme}>
            ...
            >
              ...
              {/* Wallet Status Badge - Show at bottom if wallet is connected and not on connecting/complete step */}
